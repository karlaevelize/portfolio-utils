...
export default function Leaflet(){
  ...
  return(
    <>
      ...
      <a rel="noreferrer" target="_blank" href="https://github.com/karlaevelize/leaflet-cloudinary/blob/master/src/pages/Leaflet.js">
      ...
      <MapContainer style={{border: "2px solid", borderRadius: "10px", height: "50vw", width: "60vw", maxWidth: "1000px", maxHeight: "800px", margin: "0px 19.5%"}} center={[52.36994, 4.90600]} zoom={13} scrollWheelZoom={true}>
        <TileLayer
